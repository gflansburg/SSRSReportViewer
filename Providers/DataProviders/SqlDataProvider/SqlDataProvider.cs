...
namespace Gafware.Modules.SSRSReportViewer.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "Gafware_SSRSReportViewer_";
        ...
        public override IDataReader GetReports()
        {
            return SqlHelper.ExecuteReader(ConnectionString, CommandType.StoredProcedure, NamePrefix + "GetReportList");
        }
